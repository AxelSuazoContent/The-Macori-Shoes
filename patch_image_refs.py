...
mapping = {
    ...
    'img/zapatos/candelaria-gold-1.jpeg': 'img/zapatos/candelaria blanco.jpeg',
    ...
    'img/zapatos/carmella-negro-1.jpeg': 'img/zapatos/carmella negro .jpeg',
    'img/zapatos/carmella-burgundy-1.jpeg': 'img/zapatos/carmella vino .jpeg',
    ...
    'img/zapatos/evana-rosita-1.jpeg': 'img/zapatos/evana azul .jpeg',
...
for old, new in mapping.items():
    if new.replace('img/zapatos/', '') not in real:
        raise SystemExit(f'ERROR: target file not found: {new}')
